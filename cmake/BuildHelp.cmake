...
function(BUILD_HELPFILE xmlfile VARIANT)
  ...
  FILE(GLOB_RECURSE IMAGES RELATIVE ${SRCDIR} ${IMGDIR}/*.gif ${IMGDIR}/*.jpg ${IMGDIR}/*.png)
  file(MAKE_DIRECTORY ${BUILDDIR})
  file(MAKE_DIRECTORY ${HELPDIR})

  SET(_ImgList)
  FOREACH(IMG_NAME ${IMAGES})
    ADD_CUSTOM_COMMAND(OUTPUT ${BUILDDIR}/${IMG_NAME} COMMAND ${CMAKE_COMMAND} -E copy ${SRCDIR}/${IMG_NAME} ${BUILDDIR}/${IMG_NAME} DEPENDS ${SRCDIR}/${IMG_NAME})
