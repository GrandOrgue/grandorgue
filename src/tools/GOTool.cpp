...
const wxCmdLineEntryDesc GOTool::m_cmdLineDesc[] = {
    {wxCMD_LINE_SWITCH, wxTRANSLATE("h"), wxTRANSLATE("help"),
     wxTRANSLATE("displays help on the command line parameters"),
     wxCMD_LINE_VAL_NONE, wxCMD_LINE_OPTION_HELP},
    {wxCMD_LINE_SWITCH, wxTRANSLATE("c"), wxTRANSLATE("create"),
     wxTRANSLATE("create an organ package"), wxCMD_LINE_VAL_NONE,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o"), wxTRANSLATE("organ-package"),
     wxTRANSLATE("specifiy generated organ package filename"),
     wxCMD_LINE_VAL_STRING, wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("i"), wxTRANSLATE("input-directory"),
     wxTRANSLATE("specifiy input directory"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("t"), wxTRANSLATE("title"),
     wxTRANSLATE("organ package title"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("p1"), NULL,
     wxTRANSLATE("depend on organ package"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("p2"), NULL,
     wxTRANSLATE("depend on organ package"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("p3"), NULL,
     wxTRANSLATE("depend on organ package"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("p4"), NULL,
     wxTRANSLATE("depend on organ package"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("p5"), NULL,
     wxTRANSLATE("depend on organ package"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o1"), NULL,
     wxTRANSLATE("provide odf-file-name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o2"), NULL,
     wxTRANSLATE("provide odf-file-name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o3"), NULL,
     wxTRANSLATE("provide odf-file-name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o4"), NULL,
     wxTRANSLATE("provide odf-file-name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o5"), NULL,
     wxTRANSLATE("provide odf-file-name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o6"), NULL,
     wxTRANSLATE("provide odf-file-name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o7"), NULL,
     wxTRANSLATE("provide odf-file-name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o8"), NULL,
     wxTRANSLATE("provide odf-file-name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o9"), NULL,
     wxTRANSLATE("provide odf-file-name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_OPTION, wxTRANSLATE("o10"), NULL,
     wxTRANSLATE("provide odf-file-name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_NONE}};
...
bool GOTool::CmdLineCreate(wxCmdLineParser& parser) {
  ...
  if (!CreateOrganPackage(organPackage, title, inputDirectory, odfs,
                          packages)) {
...
bool GOTool::CreateOrganPackage(wxString organPackage, wxString title,
                                wxString inputDirectory,
                                std::vector<wxString> odfs,
                                std::vector<wxString> packages) {
  GOSettingDirectory cacheDir(NULL, wxEmptyString, wxEmptyString,
                              wxEmptyString);
  cacheDir(GOStdPath::GetCacheDir() + wxFileName::GetPathSeparator() +
