...
const wxString& GOLabel::GetName()
{
	return m_Name;
}

const wxString& GOLabel::GetContent()
{
	return m_Content;
}
...
void GOLabel::PrepareRecording()
{
	m_sender.SetLabel(m_Content);
}

wxString GOLabel::GetMidiType()
{
	return _("Label");
}

wxString GOLabel::GetMidiName()
{
	return GetName();
}
...
wxString GOLabel::GetElementStatus()
{
	return m_Content;
}
