...
static inline void AudioWriteCompressed8(unsigned char* data,
                                         unsigned& output_len, int encode) {
...
static inline void AudioWriteCompressed16(unsigned char* data,
                                          unsigned& output_len, int encode) {
...
static inline void DecompressionStep(DecompressionCache& cache,
                                     unsigned channels, bool format16) {
...
static inline void DecompressTo(DecompressionCache& cache, unsigned position,
                                const unsigned char* data, unsigned channels,
                                bool format16) {
