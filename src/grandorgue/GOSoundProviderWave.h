...
public:
	...
	void LoadFromFile(std::vector<attack_load_info> attacks, std::vector<release_load_info> releases, wxString path, unsigned bits_per_sample, int channels, bool compress, loop_load_type loop_mode,
