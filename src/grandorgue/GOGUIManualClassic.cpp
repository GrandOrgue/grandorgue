...
GOGUIManualClassic::GOGUIManualClassic(GOGUIPanel* panel, GOrgueManual* manual, unsigned manual_number):
...
void GOGUIManualClassic::Load(IniFileConfig& cfg, wxString group)
{
...
void GOGUIManualClassic::GetKeyDimensions(unsigned key_midi_nb, int &x, int &cx, int &cy, int &z)
{
...
wxRegion GOGUIManualClassic::GetKeyRegion(unsigned key_nb)
{
...
void GOGUIManualClassic::DrawKey(wxDC* dc, unsigned key_nb)
{
...
void GOGUIManualClassic::Draw(wxDC* dc)
{
	const GOGUIDisplayMetrics::MANUAL_RENDER_INFO &mri = m_metrics->GetManualRenderInfo(m_ManualNumber);
...
void GOGUIManualClassic::HandleMousePress(int x, int y, bool right, GOGUIMouseState& state)
{
