...
GOPipeConfigTreeNode::GOPipeConfigTreeNode(GOPipeConfigNode* parent, GODefinitionFile* organfile, GOPipeUpdateCallback* callback) :
...
unsigned GOPipeConfigTreeNode::GetChildCount()
{
