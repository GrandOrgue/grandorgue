...
void GOManual::Init(GOConfigReader& cfg, wxString group, int manualNumber, unsigned first_midi, unsigned keys)
{
...
void GOManual::Load(GOConfigReader& cfg, wxString group, int manualNumber)
{
	...
	{
		m_stops.push_back(new GOStop(m_organfile, GetFirstLogicalKeyMIDINoteNumber()));
	...
	{
		m_divisionals.push_back(new GODivisional(m_organfile, GetDivisionalTemplate(), false));
...
void GOManual::SetKey(unsigned note, unsigned velocity, GOCoupler* prev, unsigned couplerID)
{
...
const wxString& GOManual::GetName()
{
	return m_name;
}

int GOManual::GetMIDIInputNumber()
{
	return m_MIDIInputNumber;
}

unsigned GOManual::GetLogicalKeyCount()
{
	return m_nb_logical_keys;
}

unsigned GOManual::GetNumberOfAccessibleKeys()
{
...
unsigned GOManual::GetStopCount()
{
	return m_stops.size();
}
...
unsigned GOManual::GetCouplerCount()
{
	return m_couplers.size();
}

unsigned GOManual::GetODFCouplerCount()
{
...
void GOManual::AddCoupler(GOCoupler* coupler)
{
	m_couplers.push_back(coupler);
}

unsigned GOManual::GetDivisionalCount()
{
...
unsigned GOManual::GetTremulantCount()
{
...
unsigned GOManual::GetSwitchCount()
{
...
wxString GOManual::GetMidiType()
{
	return _("Manual");
}

wxString GOManual::GetMidiName()
{
	return GetName();
}
...
wxString GOManual::GetElementStatus()
{
	return _("-");
}
