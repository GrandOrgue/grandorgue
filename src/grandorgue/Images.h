...
wxBitmap GetImage_draw3off();
wxBitmap GetImage_draw3on();
wxBitmap GetImage_draw4off();
wxBitmap GetImage_draw4on();
wxBitmap GetImage_draw5off();
wxBitmap GetImage_draw5on();
wxBitmap GetImage_draw6off();
wxBitmap GetImage_draw6on();
wxBitmap GetImage_fpiston();
wxBitmap GetImage_fpiston2();
wxBitmap GetImage_piston3off();
wxBitmap GetImage_piston3on();
wxBitmap GetImage_piston4off();
wxBitmap GetImage_piston4on();
wxBitmap GetImage_piston5off();
wxBitmap GetImage_piston5on();;
wxBitmap GetImage_gauge();
wxBitmap GetImage_help();
wxBitmap GetImage_hpiston();
wxBitmap GetImage_hpiston2();
wxBitmap GetImage_label();
wxBitmap GetImage_label2();
wxBitmap GetImage_label3();
wxBitmap GetImage_label4();
wxBitmap GetImage_label5();
wxBitmap GetImage_label6();
wxBitmap GetImage_label7();
wxBitmap GetImage_label8();
wxBitmap GetImage_label9();
wxBitmap GetImage_label10();
wxBitmap GetImage_label11();
wxBitmap GetImage_label12();
