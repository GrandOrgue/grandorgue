...
void GOSetter::Load(GOConfigReader& cfg)
{
	...
	{
		m_framegeneral.push_back(new GOFrameGeneral(m_organfile->GetGeneralTemplate(), m_organfile, true));
	...
	{
		m_general.push_back(new GOFrameGeneral(m_organfile->GetGeneralTemplate(), m_organfile, true));
	...
	{
		m_crescendo.push_back(new GOFrameGeneral(m_organfile->GetGeneralTemplate(), m_organfile, true));
...
unsigned GOSetter::GetPosition()
{
	return m_pos;
}

SetterType GOSetter::GetSetterType()
{
	return m_SetterType;
}
