...
GOPipeUpdateCallback* GOPipeConfig::GetCallback()
{
	return m_Callback;
}

const wxString& GOPipeConfig::GetAudioGroup()
{
	return m_AudioGroup;
}
...
float GOPipeConfig::GetAmplitude()
{
	return m_Amplitude;
}

float GOPipeConfig::GetDefaultAmplitude()
{
...
float GOPipeConfig::GetGain()
{
	return m_Gain;
}

float GOPipeConfig::GetDefaultGain()
{
...
float GOPipeConfig::GetTuning()
{
	return m_Tuning;
}

float GOPipeConfig::GetDefaultTuning()
{
...
unsigned GOPipeConfig::GetDelay()
{
	return m_Delay;
}

unsigned GOPipeConfig::GetDefaultDelay()
{
...
int  GOPipeConfig::GetBitsPerSample()
{
...
int  GOPipeConfig::GetAttackLoad()
{
	return m_AttackLoad;
}
...
int  GOPipeConfig::GetReleaseLoad()
{
