...
float GOWindchest::GetVolume()
{
	return m_Volume;
}

unsigned GOWindchest::GetTremulantCount()
{
	return m_tremulant.size();
}

unsigned GOWindchest::GetTremulantId(unsigned no)
{
	return m_tremulant[no];
}

unsigned GOWindchest::GetRankCount()
{
	return m_ranks.size();
}
...
void GOWindchest::AddRank(GORank* rank)
{
...
const wxString& GOWindchest::GetName()
{
	return m_Name;
}

GOPipeConfigNode& GOWindchest::GetPipeConfig()
{
	return m_PipeConfig;
}
...
void GOWindchest::PreparePlayback()
{
	UpdateVolume();
}
