...
void GOModel::Load(GOConfigReader& cfg, GODefinitionFile* organfile)
{
	...
	{
		m_general.push_back(new GOGeneral(organfile->GetGeneralTemplate(), organfile, false));
...
unsigned GOModel::GetWindchestGroupCount()
{
...
unsigned GOModel::GetODFManualCount()
{
	return m_ODFManualCount;
}

unsigned GOModel::GetFirstManualIndex()
{
	return m_FirstManual;
}

GOManual* GOModel::GetManual(unsigned index)
{
...
unsigned GOModel::GetEnclosureCount()
{
...
unsigned GOModel::GetSwitchCount()
{
	return m_switches.size();
}

GOSwitch* GOModel::GetSwitch(unsigned index)
{
	return m_switches[index];
}

unsigned GOModel::GetTremulantCount()
{
...
GORank* GOModel::GetRank(unsigned index)
{
	return m_ranks[index];
}

unsigned GOModel::GetODFRankCount()
{
	return m_ODFRankCount;
}

void GOModel::AddRank(GORank* rank)
{
	m_ranks.push_back(rank);
}

unsigned GOModel::GetNumberOfReversiblePistons()
{
	return m_piston.size();
}

GOPiston* GOModel::GetPiston(unsigned index)
{
...
unsigned GOModel::GetGeneralCount()
{
	return m_general.size();
}

GOGeneral* GOModel::GetGeneral(unsigned index)
{
