...
GOPanelView* GOPanelView::createWithFrame(GODocumentBase* doc, GOGUIPanel* panel)
{
...
GOPanelView::GOPanelView(GODocumentBase* doc, GOGUIPanel* panel, wxWindow* parent) :
