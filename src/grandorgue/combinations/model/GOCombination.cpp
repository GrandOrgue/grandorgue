  ...
  if (!m_Protected) {
    ...
    if (yamlNode.IsDefined() && yamlNode.IsMap()) {
      ...
      if (m_HasScope) {
        ...
        std::replace(m_ElementStates.begin(), m_ElementStates.end(), 1, 0);
      }
