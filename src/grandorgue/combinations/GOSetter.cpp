...
GOSetter::GOSetter(GOOrganController *organController)
  ...
  m_buttons[ID_SETTER_PREV]->SetMidiReceiverIndex(0);
  m_buttons[ID_SETTER_NEXT]->SetMidiReceiverIndex(1);
  m_buttons[ID_SETTER_SET]->SetMidiReceiverIndex(2);
  m_buttons[ID_SETTER_CURRENT]->SetMidiReceiverIndex(3);
  m_buttons[ID_SETTER_GC]->SetMidiReceiverIndex(4);
  m_buttons[ID_SETTER_M10]->SetMidiReceiverIndex(5);
  m_buttons[ID_SETTER_P10]->SetMidiReceiverIndex(6);
  m_buttons[ID_SETTER_L0]->SetMidiReceiverIndex(7);
  m_buttons[ID_SETTER_L1]->SetMidiReceiverIndex(8);
  m_buttons[ID_SETTER_L2]->SetMidiReceiverIndex(9);
  m_buttons[ID_SETTER_L3]->SetMidiReceiverIndex(10);
  m_buttons[ID_SETTER_L4]->SetMidiReceiverIndex(11);
  m_buttons[ID_SETTER_L5]->SetMidiReceiverIndex(12);
  m_buttons[ID_SETTER_L6]->SetMidiReceiverIndex(13);
  m_buttons[ID_SETTER_L7]->SetMidiReceiverIndex(14);
  m_buttons[ID_SETTER_L8]->SetMidiReceiverIndex(15);
  m_buttons[ID_SETTER_L9]->SetMidiReceiverIndex(16);
  m_buttons[ID_SETTER_PITCH_M1]->SetMidiReceiverIndex(17);
  m_buttons[ID_SETTER_PITCH_P1]->SetMidiReceiverIndex(18);
  m_buttons[ID_SETTER_PITCH_M100]->SetMidiReceiverIndex(19);
  m_buttons[ID_SETTER_PITCH_P100]->SetMidiReceiverIndex(20);
  m_buttons[ID_SETTER_TEMPERAMENT_PREV]->SetMidiReceiverIndex(21);
  m_buttons[ID_SETTER_TEMPERAMENT_NEXT]->SetMidiReceiverIndex(22);
  m_buttons[ID_SETTER_TRANSPOSE_DOWN]->SetMidiReceiverIndex(23);
  m_buttons[ID_SETTER_TRANSPOSE_UP]->SetMidiReceiverIndex(24);
  m_buttons[ID_SETTER_AUDIO_PANIC]->SetMidiReceiverIndex(25);
  m_buttons[ID_SETTER_FILE_EXIT]->SetMidiReceiverIndex(26);
