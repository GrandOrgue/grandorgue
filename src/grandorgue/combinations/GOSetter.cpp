...
const GOElementCreator::ButtonDefinitionEntry BUTTON_DEFS[] = {
  {wxT("Prev"), ID_SETTER_PREV, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("Next"), ID_SETTER_NEXT, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("Set"), ID_SETTER_SET, true, false, false, &MIDI_CONTEXT_SETTER},
  {wxT("M1"), ID_SETTER_M1, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("M10"), ID_SETTER_M10, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("M100"), ID_SETTER_M100, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("P1"), ID_SETTER_P1, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("P10"), ID_SETTER_P10, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("P100"), ID_SETTER_P100, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("Current"),
   ID_SETTER_CURRENT,
   true,
   true,
  ...
  {wxT("Home"), ID_SETTER_HOME, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("GC"), ID_SETTER_GC, true, true, false, &MIDI_CONTEXT_SETTER},
  {wxT("L1"), ID_SETTER_L1, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("L2"), ID_SETTER_L2, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("L3"), ID_SETTER_L3, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("L4"), ID_SETTER_L4, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("L5"), ID_SETTER_L5, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("L6"), ID_SETTER_L6, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("L7"), ID_SETTER_L7, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("L8"), ID_SETTER_L8, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("L9"), ID_SETTER_L9, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("L0"), ID_SETTER_L0, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  ...
  {wxT("Insert"), ID_SETTER_INSERT, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  {wxT("Delete"), ID_SETTER_DELETE, true, true, false, &MIDI_CONTEXT_SEQUENCER},
  ...
  {wxT("PitchP1"), ID_SETTER_PITCH_P1, true, true, false, &MIDI_CONTEXT_PITCH},
  {wxT("PitchP10"),
   ID_SETTER_PITCH_P10,
   true,
   true,
  ...
  {wxT("PitchP100"),
   ...
   false,
   &MIDI_CONTEXT_PITCH},
  {wxT("PitchM1"), ID_SETTER_PITCH_M1, true, true, false, &MIDI_CONTEXT_PITCH},
  {wxT("PitchM10"),
   ID_SETTER_PITCH_M10,
   true,
   true,
  ...
  {wxT("PanicButton"),
   ...
   true,
   &MIDI_CONTEXT_SETTER},
  {wxT("ExitGO"), ID_SETTER_FILE_EXIT, true, true, true, &MIDI_CONTEXT_SETTER},
