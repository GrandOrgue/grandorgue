...
const wxCmdLineEntryDesc GOApp::m_cmdLineDesc[] = {
    ...
    {wxCMD_LINE_OPTION, wxTRANSLATE("i"), wxTRANSLATE("instance"),
     wxTRANSLATE("specifiy GrandOrgue instance name"), wxCMD_LINE_VAL_STRING,
     wxCMD_LINE_PARAM_OPTIONAL},
    {wxCMD_LINE_PARAM, NULL, NULL, wxTRANSLATE("organ file"),
...
bool GOApp::OnInit() {
  ...
  m_Frame =
      new GOFrame(*this, NULL, wxID_ANY,
