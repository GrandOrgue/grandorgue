...
wxString GODefinitionFile::GetOrganHash()
{
	return m_hash;
}
...
wxString GODefinitionFile::Load(GOProgressDialog* dlg, const GOOrgan& organ, const wxString& file2)
{
	GOFilename odf_name;
...
bool GODefinitionFile::CachePresent()
{
...
void GODefinitionFile::DeleteSettings()
{
...
GOEnclosure* GODefinitionFile::GetEnclosure(const wxString& name, bool is_panel)
{
	for(unsigned i = 0; i < m_elementcreators.size(); i++)
	{
...
GODocument* GODefinitionFile::GetDocument()
{
	return m_doc;
}

void GODefinitionFile::SetVolume(int volume)
{
	m_volume = volume;
}

int GODefinitionFile::GetVolume()
{
	return m_volume;
}

void GODefinitionFile::SetIgnorePitch(bool ignore)
{
	m_IgnorePitch = ignore;
}

bool GODefinitionFile::GetIgnorePitch()
{
...
GOSetter* GODefinitionFile::GetSetter()
{
	return m_setter;
}
...
unsigned GODefinitionFile::GetPanelCount()
{
...
const wxString& GODefinitionFile::GetChurchName()
{
	return m_ChurchName;
}

const wxString& GODefinitionFile::GetChurchAddress()
{
	return m_ChurchAddress;
}

const wxString& GODefinitionFile::GetOrganBuilder()
{
...
const wxString& GODefinitionFile::GetOrganComments()
{
...
const wxString& GODefinitionFile::GetInfoFilename()
{
	return m_InfoFilename;
}

bool GODefinitionFile::useArchives()
{
...
GOPipeConfigNode& GODefinitionFile::GetPipeConfig()
{
	return m_PipeConfig;
}
...
bool GODefinitionFile::IsCustomized()
{
	return m_b_customized;
}

const wxString GODefinitionFile::GetODFFilename()
{
	return m_odf;
}

const wxString GODefinitionFile::GetODFPath()
{
	return m_path.c_str();
}
...
{
	return GOOrgan(GetODFFilename(), m_ArchiveID, GetChurchName(), GetOrganBuilder(), GetRecordingDetails());
}
...
const wxString GODefinitionFile::GetCacheFilename()
{
	return m_CacheFilename;
}

GOMemoryPool& GODefinitionFile::GetMemoryPool()
{
	return m_pool;
}
...
GOBitmapCache& GODefinitionFile::GetBitmapCache()
{
	return m_bitmaps;
}
...
GOMidi* GODefinitionFile::GetMidi()
{
	return m_midi;
}
...
void GODefinitionFile::PreparePlayback(GOSoundEngine* engine, GOMidi* midi, GOSoundRecorder* recorder)
{
...
wxString GODefinitionFile::GetTemperament()
{
...
GOLabel* GODefinitionFile::GetPitchLabel()
{
	return &m_PitchLabel;
}

GOLabel* GODefinitionFile::GetTemperamentLabel()
{
...
void GODefinitionFile::SetODFPath(wxString path)
{
	m_path = path;
}
