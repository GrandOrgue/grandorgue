...
class GOCoupler : public GODrawstop {
 ...
 public:
  ...
  void Init(GOConfigReader& cfg, wxString group, wxString name, bool unison_off,
            bool recursive, int keyshift, int dest_manual,
            GOCouplerType coupler_type);
  void Load(GOConfigReader& cfg, wxString group);
  void SetKey(unsigned note, const std::vector<unsigned>& velocities,
