...
{
	m_Type = (GOFunctionType)cfg.ReadEnum(ODFSetting, group, wxT("Function"), m_function_types, sizeof(m_function_types) / sizeof(m_function_types[0]), false, FUNCTION_INPUT);
...
bool GODrawstop::IsActive() const
{
...
bool GODrawstop::GetCombinationState() const
{
	return IsEngaged();
}

bool GODrawstop::GetStoreDivisional() const
{
	return m_StoreDivisional;
}

bool GODrawstop::GetStoreGeneral() const
{
