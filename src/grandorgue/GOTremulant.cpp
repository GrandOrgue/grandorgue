...
void GOTremulant::Load(GOConfigReader& cfg, wxString group,
                       int sampler_group_id) {
  m_TremulantType = (GOTremulantType)cfg.ReadEnum(
      ODFSetting, group, wxT("TremulantType"), m_tremulant_types,
      sizeof(m_tremulant_types) / sizeof(m_tremulant_types[0]), false,
      GOSynthTrem);
