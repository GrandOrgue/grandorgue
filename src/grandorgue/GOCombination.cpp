...
GOCombination::GOCombination(GOCombinationDefinition& combination_template, GODefinitionFile* organfile) :
...
int GOCombination::GetState(unsigned no)
{
	return m_State[no];
}

void GOCombination::SetState(unsigned no, int value)
{
	m_State[no] = value;
}
...
GOCombinationDefinition* GOCombination::GetTemplate()
{
	return &m_Template;
}
