...
GOGeneral::GOGeneral(GOCombinationDefinition& general_template, GODefinitionFile* organfile, bool is_setter):
...
GOFrameGeneral& GOGeneral::GetGeneral()
{
	return m_general;
}

wxString GOGeneral::GetMidiType()
{
	return _("General");
}
