...
void GOEnclosure::Init(GOConfigReader& cfg, wxString group, wxString Name, unsigned def_value)
{
...
int GOEnclosure::GetMIDIInputNumber()
{
...
const wxString& GOEnclosure::GetName()
{
	return m_Name;
}

int GOEnclosure::GetValue()
{
	return m_MIDIValue;
}
...
wxString GOEnclosure::GetMidiType()
{
	return _("Enclosure");
}

wxString GOEnclosure::GetMidiName()
{
	return GetName();
}
