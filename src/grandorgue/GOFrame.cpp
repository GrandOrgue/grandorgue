...
void GOFrame::InitHelp()
{
	...
	wxString searchpath;
	searchpath.Append(GOStdPath::GetResourceDir() + wxFILE_SEP_PATH + wxT("help"));
...
GODocument* GOFrame::GetDocument()
{
	return m_doc;
}
...
void GOFrame::OnExit(wxCommandEvent& event)
{
	Close();
}
...
void GOFrame::DoSplash(bool timeout)
{
