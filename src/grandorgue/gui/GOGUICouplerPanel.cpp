...
GOGUIPanel* GOGUICouplerPanel::CreateCouplerPanel(GOConfigReader& cfg,
                                                  unsigned manual_nr) {
  ...
  for (unsigned int i = m_organfile->GetFirstManualIndex();
       i < m_organfile->GetODFManualCount(); i++) {
    int x, y;
    ...
    PosDisplay->Init(
        cfg, wxString::Format(wxT("SetterCoupler%03dLabel%03d"), manual_nr, i),
        x, y, dest_manual->GetName());
    ...
    coupler->Init(
        ...
        _("16"), false, false, -12, i, GOCoupler::COUPLER_NORMAL);
    ...
    coupler->Init(
        ...
        manual_nr != i ? _("8") : _("U.O."), manual_nr == i, false, 0, i,
    ...
    button->Init(
        cfg,
        wxString::Format(wxT("SetterManual%03dCoupler%03dT8"), manual_nr, i), 3,
        100 + i);
    panel->AddControl(button);
    ...
    coupler->Init(
        ...
        _("4"), false, false, 12, i, GOCoupler::COUPLER_NORMAL);
    coupler->SetElementID(m_organfile->GetRecorderElementID(
    ...
    button->Init(
        cfg,
        wxString::Format(wxT("SetterManual%03dCoupler%03dT4"), manual_nr, i), 4,
        100 + i);
    panel->AddControl(button);
    ...
    coupler->Init(
        ...
        _("BAS"), false, false, 0, i, GOCoupler::COUPLER_BASS);
    coupler->SetElementID(m_organfile->GetRecorderElementID(
    ...
    coupler->Init(
        ...
        _("MEL"), false, false, 0, i, GOCoupler::COUPLER_MELODY);
    coupler->SetElementID(m_organfile->GetRecorderElementID(
