...
void GOGUILayoutEngine::GetDrawstopBlitPosition(const int drawstopRow,
                                                const int drawstopCol,
                                                int& blitX, int& blitY) {
  int i;
  if (drawstopRow > 99) {
    blitX =
    ...
    if (m_metrics.HasDrawstopColsOffset() &&
        (i & 1) ^ m_metrics.HasDrawstopOuterColOffsetUp())
      blitY += m_metrics.GetDrawstopHeight() / 2;
  }
}

void GOGUILayoutEngine::GetPushbuttonBlitPosition(const int buttonRow,
                                                  const int buttonCol,
                                                  int& blitX, int& blitY) {
...
void GOGUILayoutEngine::Update() {
  ...
  if (m_CenterWidth + GetJambLeftRightWidth() * 2 <
