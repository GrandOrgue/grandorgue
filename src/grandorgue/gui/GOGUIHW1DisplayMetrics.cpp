...
GOGUIHW1DisplayMetrics::GOGUIHW1DisplayMetrics(GOConfigReader& ini,
                                               wxString group)
    : GOGUIDisplayMetrics() {
  ...
  m_DispDrawstopOuterColOffsetUp =
      ini.ReadBoolean(ODFSetting, group, wxT("DispDrawstopOuterColOffsetUp"),
                      m_DispDrawstopColsOffset);
  ...
  m_DispExtraPedalButtonRowOffset =
      ini.ReadBoolean(ODFSetting, group, wxT("DispExtraPedalButtonRowOffset"),
                      m_DispExtraPedalButtonRow);
  m_DispExtraPedalButtonRowOffsetRight = ini.ReadBoolean(
      ODFSetting, group, wxT("DispExtraPedalButtonRowOffsetRight"),
      m_DispExtraPedalButtonRow);
  ...
  m_DrawStopWidth = ini.ReadInteger(ODFSetting, group, wxT("DispDrawstopWidth"),
                                    1, 150, false, 78),
  m_DrawStopHeight = ini.ReadInteger(
      ODFSetting, group, wxT("DispDrawstopHeight"), 1, 150, false, 69),
  m_ButtonWidth = ini.ReadInteger(ODFSetting, group, wxT("DispPistonWidth"), 1,
                                  150, false, 44),
  m_ButtonHeight = ini.ReadInteger(ODFSetting, group, wxT("DispPistonHeight"),
                                   1, 150, false, 40),
  ...
  m_PedalHeight = ini.ReadInteger(ODFSetting, group, wxT("DispPedalHeight"), 1,
                                  500, false, 40),
  m_PedalKeyWidth = ini.ReadInteger(ODFSetting, group, wxT("DispPedalKeyWidth"),
                                    1, 500, false, 7),
  m_ManualHeight = ini.ReadInteger(ODFSetting, group, wxT("DispManualHeight"),
                                   1, 500, false, 32),
