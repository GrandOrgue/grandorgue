...
// AddChannelFrom applied directly to a mono destination (single call) —
// compare with TestPerfAddChannelFromMonoRecipient's two-step
// copy-then-add above to evaluate the benefit of the dedicated method.
static constexpr GOTestPerfSoundBufferBaseline BASELINE_ADD_CHANNEL_FROM_MONO[]
  = {
#ifdef NDEBUG
    {32, 1500},  // measured: 2005.5, -25% margin
    {128, 1800}, // measured: 2412.0, -25% margin
    {512, 2150}, // measured: 2905.1, -25% margin
    {2048, 2150} // measured: 2916.6, -25% margin
#else
    {32, 900},   // debug, measured: 1264.2, -25% margin
    {128, 1300}, // debug, measured: 1796.0, -25% margin
    {512, 1500}, // debug, measured: 2061.5, -25% margin
    {2048, 1550} // debug, measured: 2126.1, -25% margin
#endif
};
