...
void GOTestSoundOrganEngine::TestDownmixGainsWithOneGroup() {
...
void GOTestSoundOrganEngine::TestDownmixGainsWithTwoGroups() {
...
void GOTestSoundOrganEngine::TestDefaultOutputConfigs() {
...
void GOTestSoundOrganEngine::TestDefaultOutputConfigsMatchesDownmixGains() {
  for (unsigned nAudioGroups = 1; nAudioGroups <= 2; nAudioGroups++) {
    const std::vector<GOSoundOrganEngine::AudioOutputConfig> configs
      = GOSoundOrganEngine::createDefaultOutputConfigs(nAudioGroups);
    const GOSoundOrganEngine::AudioOutputConfig &config = configs[0];
