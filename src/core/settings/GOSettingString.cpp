...
GOSettingString::GOSettingString(GOSettingStore* store, wxString group, wxString name, wxString default_value) :
...
wxString GOSettingString::getDefaultValue()
{
	return m_DefaultValue;
}

wxString GOSettingString::operator() () const
{
	return m_Value;
}

void GOSettingString::operator()(wxString value)
{
	m_Value = validate(value);
}

wxString GOSettingString::validate(wxString value)
{
	return value;
}
