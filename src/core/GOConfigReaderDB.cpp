...
bool GOConfigReaderDB::ReadData(GOConfigFileReader& ODF, GOSettingType type, bool handle_prefix)
{
...
void GOConfigReaderDB::AddEntry(GOStringHashMap& hash, wxString key, wxString value)
{
...
bool GOConfigReaderDB::GetString(GOSettingType type, wxString group, wxString key, wxString& value)
{
