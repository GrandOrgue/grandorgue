...
GOArchiveIndex::GOArchiveIndex(const GOSettingDirectory& cachePath, const wxString& path) :
...
bool GOArchiveIndex::ReadContent(wxString& id, std::vector<GOArchiveEntry>& entries)
{
	if (!ReadString(id))
		return false;
...
bool GOArchiveIndex::WriteContent(const wxString& id, const std::vector<GOArchiveEntry>& entries)
{
...
bool GOArchiveIndex::ReadIndex(wxString& id, std::vector<GOArchiveEntry>& entries)
{
...
bool GOArchiveIndex::WriteIndex(const wxString& id, const std::vector<GOArchiveEntry>& entries)
{
	wxString name = GenerateIndexFilename();
