...
void GOMidiEvent::FromMidi(const std::vector<unsigned char>& msg, GOMidiMap& map)
{
...
void GOMidiEvent::ToMidi(std::vector<std::vector<unsigned char>>& msg, GOMidiMap& map) const
{
	msg.resize(0);
