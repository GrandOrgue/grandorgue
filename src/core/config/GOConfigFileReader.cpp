...
wxString GOConfigFileReader::GetHash()
{
	return m_Hash;
}

const std::map<wxString, std::map<wxString, wxString> >& GOConfigFileReader::GetContent()
{
	return m_Entries;
}

wxString GOConfigFileReader::GetNextLine(const wxString& buffer, unsigned &pos)
{
