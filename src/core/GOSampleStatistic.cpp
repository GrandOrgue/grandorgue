...
bool GOSampleStatistic::IsValid() const
{
	return m_Valid;
}
...
size_t GOSampleStatistic::GetMemorySize() const
{
	return m_MemorySize;
}
...
void GOSampleStatistic::SetBitsPerSample(unsigned bits, unsigned samples, unsigned max_value)
{
...
size_t GOSampleStatistic::GetEndSegmentSize() const
{
