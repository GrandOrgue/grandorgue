...
GOLogWindow::GOLogWindow(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) :
...
void GOLogWindow::OnClear(wxCommandEvent& event)
{
...
void GOLogWindow::LogMsg(wxLogLevel level, const wxString& msg, time_t timestamp)
{
