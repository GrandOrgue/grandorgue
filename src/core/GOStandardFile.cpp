...
GOStandardFile::~GOStandardFile()
{
	Close();
}

const wxString GOStandardFile::GetName()
{
	return m_Name;
}

const wxString GOStandardFile::GetPath()
{
	return m_Path;
}

size_t GOStandardFile::GetSize()
{
	return m_Size;
}
