...
bool GOConfigReader::Read(GOSettingType type, wxString group, wxString key, bool required, wxString& value)
{
	bool found = false;
...
wxString GOConfigReader::ReadString(GOSettingType type, wxString group, wxString key, bool required, wxString defaultValue)
{
	wxString value;
...
wxString GOConfigReader::ReadString(GOSettingType type, wxString group, wxString key, bool required)
{
	return ReadString(type, group, key, required, wxT(""));
}

wxString GOConfigReader::ReadStringTrim(GOSettingType type, wxString group, wxString key, bool required, wxString defaultValue)
{
...
wxString GOConfigReader::ReadStringTrim(GOSettingType type, wxString group, wxString key, bool required)
{
	return ReadStringTrim(type, group, key, required, wxT(""));
}

wxString GOConfigReader::ReadStringNotEmpty(GOSettingType type, wxString group, wxString key, bool required, wxString defaultValue)
{
	wxString value = ReadString(type, group, key, required, defaultValue);
...
wxString GOConfigReader::ReadStringNotEmpty(GOSettingType type, wxString group, wxString key, bool required)
{
	return ReadStringNotEmpty(type, group, key, required, wxT(""));
}

bool GOConfigReader::ReadBoolean(GOSettingType type, wxString group, wxString key, bool required)
{
	return ReadBoolean(type, group, key, required, false);
}

bool GOConfigReader::ReadBoolean(GOSettingType type, wxString group, wxString key, bool required, bool defaultValue)
{
	wxString value;
...
wxColour GOConfigReader::ReadColor(GOSettingType type, wxString group, wxString key, bool required)
{
	return ReadColor(type, group, key, required, wxT("BLACK"));
}

wxColour GOConfigReader::ReadColor(GOSettingType type, wxString group, wxString key, bool required, wxString defaultValue)
{
	wxString value;
	if (!Read(type, group, key, required, value))
		value = defaultValue;
...
int GOConfigReader::ReadInteger(GOSettingType type, wxString group, wxString key, int nmin, int nmax, bool required)
{
	return ReadInteger(type, group, key, nmin, nmax, required, nmin);
}

int GOConfigReader::ReadInteger(GOSettingType type, wxString group, wxString key, int nmin, int nmax, bool required, int defaultValue)
{
	wxString value;
	if (!Read(type, group, key, required, value))
		return defaultValue;
...
int GOConfigReader::ReadLong(GOSettingType type, wxString group, wxString key, int nmin, int nmax, bool required)
{
	return ReadInteger(type, group, key, nmin, nmax, required);
}

int GOConfigReader::ReadLong(GOSettingType type, wxString group, wxString key, int nmin, int nmax, bool required, int defaultValue)
{
	return ReadInteger(type, group, key, nmin, nmax, required, defaultValue);
}

double GOConfigReader::ReadFloat(GOSettingType type, wxString group, wxString key, double nmin, double nmax, bool required)
{
	return ReadFloat(type, group, key, nmin, nmax, required, nmin);
}

double GOConfigReader::ReadFloat(GOSettingType type, wxString group, wxString key, double nmin, double nmax, bool required, double defaultValue)
{
	wxString value;
	if (!Read(type, group, key, required, value))
		return defaultValue;
...
unsigned GOConfigReader::ReadSize(GOSettingType type, wxString group, wxString key, unsigned size_type, bool required)
{
	return ReadSize(type, group, key, size_type, required, wxT("SMALL"));
}

unsigned GOConfigReader::ReadSize(GOSettingType type, wxString group, wxString key, unsigned size_type, bool required, wxString defaultValue)
{
...
unsigned GOConfigReader::ReadFontSize(GOSettingType type, wxString group, wxString key, bool required)
{
	return ReadFontSize(type, group, key, required, wxT("NORMAL"));
}

unsigned GOConfigReader::ReadFontSize(GOSettingType type, wxString group, wxString key, bool required, wxString defaultValue)
{
	wxString value;
	if (!Read(type, group, key, required, value))
		value = defaultValue;
...
int GOConfigReader::ReadEnum(GOSettingType type, wxString group, wxString key, const struct IniFileEnumEntry* entry, unsigned count, bool required, int defaultValue)
{
	int defaultEntry = -1;
	wxString value;
...
int GOConfigReader::ReadEnum(GOSettingType type, wxString group, wxString key, const struct IniFileEnumEntry* entry, unsigned count, bool required)
{
