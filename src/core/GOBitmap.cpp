...
void GOBitmap::ScaleBMP(wxImage& img, double scale, const wxRect& rect, GOBitmap* background)
{
...
void GOBitmap::PrepareBitmap(double scale, const wxRect& rect, GOBitmap* background)
{
...
void GOBitmap::PrepareTileBitmap(double scale, const wxRect& rect, unsigned xo, unsigned yo, GOBitmap* background)
{
...
const wxBitmap& GOBitmap::GetBitmap()
{
	return m_bmp;
}

unsigned GOBitmap::GetWidth()
{
	return m_img->GetWidth();
}

unsigned GOBitmap::GetHeight()
{
