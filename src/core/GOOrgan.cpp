...
GOOrgan::GOOrgan(wxString odf, wxString archive, wxString church_name, wxString organ_builder, wxString recording_detail) :
	m_ODF(odf),
...
const wxString& GOOrgan::GetODFPath() const
{
	return m_ODF;
}

const wxString& GOOrgan::GetChurchName() const
{
	return m_ChurchName;
}

const wxString& GOOrgan::GetOrganBuilder() const
{
...
const wxString& GOOrgan::GetArchiveID() const
{
	return m_ArchiveID;
}

GOMidiReceiverBase& GOOrgan::GetMIDIReceiver()
{
	return m_midi;
}
