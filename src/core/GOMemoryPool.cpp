...
void GOMemoryPool::AddPoolAlloc(void* data)
{
...
size_t GOMemoryPool::GetAllocSize()
{
	return m_PoolSize + m_MallocSize;
}

size_t GOMemoryPool::GetMappedSize()
{
	return m_CacheSize;
}

size_t GOMemoryPool::GetPoolSize()
{
	return m_PoolLimit;
}

size_t GOMemoryPool::GetPoolUsage()
{
	return m_PoolSize;
}

size_t GOMemoryPool::GetMemoryLimit()
{
	return m_MemoryLimit;
}

bool GOMemoryPool::IsPoolFull()
{
	return m_AllocError > 0;
}

void GOMemoryPool::SetMemoryLimit(size_t limit)
{
	m_MemoryLimit = limit;
}
