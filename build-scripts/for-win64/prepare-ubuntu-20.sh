...
sudo zypper -vv --installroot /zypper install -y mingw64-fftw3 mingw64-fftw3-devel mingw64-filesystem mingw64-jack mingw64-jack-devel mingw64-libgnurx-devel mingw64-libgnurx0 mingw64-wavpack mingw64-wavpack-devel mingw64-wxWidgets-3_0-devel mingw64-wxWidgets-3_0-lang mingw64-zlib-devel mingw64-zlib1
