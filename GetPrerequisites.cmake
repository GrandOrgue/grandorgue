...
function(get_prerequisites target prerequisites_var exclude_system recurse exepath dirs)
  ...
  if("${gp_tool}" STREQUAL "objdump")
      ...
      set(gp_regex_cmp_count 1)
      set(gp_tool_known 1)
  endif("${gp_tool}" STREQUAL "objdump")
  ...
  if(NOT gp_cmd)
    # To support cross-compiling, try fallback on bintils
    if("${gp_tool}" STREQUAL "dumpbin")
      ...
      find_program(gp_cross_cmd ${CMAKE_OBJDUMP} PATHS ${gp_cmd_paths})

      if(NOT gp_cross_cmd)
        message(STATUS "warning: could not find '${gp_tool}' - cannot analyze prerequisites...")
       return()
      endif()
      set(gp_cmd ${gp_cross_cmd})
    else()
      message(STATUS "warning: could not find '${gp_tool}' - cannot analyze prerequisites...")
      return()
    endif("${gp_tool}" STREQUAL "dumpbin")
  ...
  if("${candidate}" MATCHES "${gp_regex}")
    ...
    if("${gp_tool}" STREQUAL "objdump")
      set(ri ri-NOTFOUND)
      find_file(ri "${item}" PATHS ${exepath} ${dirs} CMAKE_FIND_ROOT_PATH)
      find_file(ri "${item}" PATHS ${exepath} ${dirs} NO_CMAKE_FIND_ROOT_PATH)
      if(ri)
        set(item ${ri})
      endif(ri)
    endif("${gp_tool}" STREQUAL "objdump")
